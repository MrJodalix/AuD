...
/**
 * Zur Erstellung von der Expression-Instanz Equivalence.
 *
...
public class Equivalence extends BinaryOperation {
     ...
     */
    public Equivalence(int childrenCount, Expression left, Expression right) {
    ...
    public boolean evaluateComplete(Context c) throws IncompleteContextException {
        //nicht evaluateShort aufrufen, um in evaluateComplete zu bleiben
