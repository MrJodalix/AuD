...
/**
 * Zur Erstellung von der Expression-Instanz Consequence.
 *
 * @author Ilana Schmara, Joshua-Scott Schöttke Gruppe 21
 */
public class Consequence extends BinaryOperation {
     ...
     */
    public Consequence(int childrenCount, Expression left, Expression right) {
